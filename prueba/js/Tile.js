...
{
    this.rectangulo = new Rectangulo(xEnTiles, yEnTiles,ancho,alto); //posición del Tile, el rectangulo que lo va a reperesentar
    this.zIndex = z;
    this.sprite = sprite;
...
Tile.prototype.aplicarEstilos = function()
{
    ...
    document.getElementById(this.idHTML).style.zIndex ="" + (this.xIndex);
