function PaletaSprites(datosSprites)
{
    ...
    {
        var idActualSobreZero = this.primerSpriteSobreUno -1 + s; //sprite sobre uno, y queremos la id sobre cero. asi, cada vez que la s aumente de valor se irá sumnado a la id y asi sabemos cual es el id acutal sobre cero
